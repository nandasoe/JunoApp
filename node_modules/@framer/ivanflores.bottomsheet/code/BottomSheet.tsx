...
const data = Data({ setSheetPositon: "", numSheetUpdate: 0 })

export function TapToBottom(): Override {
    return {
        onTap() {
...
export function TapToMiddle(): Override {
    return {
        onTap() {
...
export function TapToTop(): Override {
    return {
        onTap() {
...
export function updateSheetState(): Override {
    return {
