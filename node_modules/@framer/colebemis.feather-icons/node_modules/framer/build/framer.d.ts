...
declare module 'framer' {
    ...
    export { Linear, Spring } from "framer/types/src/animation/Animators";
    ...
    export { Frame, Scroll, Page, Draggable, Stack, Navigation } from "framer/types/src/components";
    ...
    export { ValueInterpolation } from "framer/types/src/interpolation/value";
    export * from "framer/types/src/components/devices/Devices";
    export { Point, Size, Rect, Vector, VectorGroup, ComponentContainer, SVG, Text, componentLoader, setGlobalRenderEnvironment, RenderTarget, ControlType, PropertyControls, updateComponentLoader, getURLs, NavigationLink, isReactDefinition, createDesignComponent, CanvasStore } from "framer/types/src/render";
    export { events };
    ...
    export { FramerFunction, WithFramerFunction } from "framer/types/src/data/WithFramerFunction";
...
declare module 'framer/types/src/animation/animate' {
    ...
    import { TensionFrictionSpringOptions } from "framer/types/src/animation/Animators";
    ...
    export function animate<Value, Options>(from: Animatable<Value> | AnimatableObject<Value>, to: Value | AnimatableObject<Value>, animator?: AnimatorClass<Value, Options>, options?: Partial<Options>, interpolation?: Interpolation<Value>): FramerAnimation;
    export namespace animate {
        function linear<Value>(from: Animatable<Value> | AnimatableObject<Value>, to: Value | AnimatableObject<Value>, duration?: number, interpolation?: Interpolation<Value>): FramerAnimation;
        function spring<Value>(from: Animatable<Value> | AnimatableObject<Value>, to: Value | AnimatableObject<Value>, options?: Partial<TensionFrictionSpringOptions>, interpolation?: Interpolation<Value>): FramerAnimation;
    }
}
...
declare module 'framer/types/src/animation/FramerAnimation' {
    ...
    import { PrecalculationOptions } from "framer/types/src/animation/Animators/PrecalculatedAnimator";
    export type FramerAnimationState = "idle" | "running" | "finished";
    export class FramerAnimation<Value = any, Options = any> {
        driver: AnimationDriver<AnimatorInterface<Value, Options>, Value, Options>;
        constructor(target: Animatable<Value> | AnimatableObject<Value>, from: Value, to: Value, animatorClass?: AnimatorClass<Value, Options>, options?: Options, interpolation?: Interpolation<Value>, preCalculation?: Partial<PrecalculationOptions>, driverClass?: DriverClass<AnimatorInterface<Value, Options>, Value, Options>);
...
declare module 'framer/types/src/animation/Animators' {
    export { LinearAnimator as Linear, Options as LinearOptions } from "framer/types/src/animation/Animators/LinearAnimator";
    ...
    export { SpringAnimator as Spring, TensionFrictionSpringOptions, DampingDurationSpringOptions } from "framer/types/src/animation/Animators/SpringAnimator";
...
declare module 'framer/types/src/components' {
    export { Frame } from "framer/types/src/components/Frame";
...
declare module 'framer/types/src/components/devices/Device' {
    ...
    export class Device extends React.Component<Partial<DeviceProperties>> {
        ...
        readonly mask: JSX.Element | undefined;
...
declare module 'framer/types/src/interpolation/value' {
    import { Interpolation } from "framer/types/src/interpolation/Interpolation";
    export function interpolationForValue(value: any): Interpolation<any>;
    export const ValueInterpolation: Interpolation<any>;
}
...
declare module 'framer/types/src/render' {
    ...
    export { imageForFill, imageURL, imageScalingMethod, QualityOptions } from "framer/types/src/render/utils/imageForFill";
    export { imagePatternPropsForFill } from "framer/types/src/render/utils/imagePatternPropsForFill";
    export { componentLoader, updateComponentLoader, ComponentDefinition, isReactDefinition } from "framer/types/src/render/utils/componentLoader";
    export { BooleanControlDescription, NumberControlDescription, StringControlDescription, FusedNumberControlDescription, EnumControlDescription, SegmentedEnumControlDescription, ColorControlDescription, ImageControlDescription, ChildrenControlDescription, ControlType, PropertyControls } from "framer/types/src/render/types/PropertyControls";
...
declare module 'framer/types/src/data/Data' {
    import { Observer } from "framer/types/src/animation/Animatable/Observers";
    import { Cancel, AnimatableObject } from "framer/types/src/animation/Animatable";
    export function Data<T extends object = object>(initial?: Partial<T> | object): AnimatableObject<T>;
...
declare module 'framer/types/src/data/WithFramerFunction' {
    import * as React from "react";
    export type FramerFunction<P = any> = (props: P) => Partial<P>;
    export function WithFramerFunction<T>(Component: React.ComponentType<T>, transform: FramerFunction<T>): (props: T) => JSX.Element;
}
...
declare module 'framer/types/src/animation/Animatable/Animatable' {
    ...
    export interface Animatable<Value> extends UpdateObserver<Value> {
        get(): Value;
        set(value: Value, transaction?: TransactionId): void;
...
declare module 'framer/types/src/interpolation/Interpolation' {
    ...
    export interface Interpolation<Value> {
        ...
        span(from: Value, to: Value): number;
    }
}
...
declare module 'framer/types/src/animation/Animators/Animator' {
    ...
    export interface AnimatorClass<Value, Options = any> {
        new (options?: Options, interpolation?: Interpolation<Value>): Animator<Value, Options>;
    }
}
...
declare module 'framer/types/src/animation/Animators/PrecalculatedAnimator' {
...
declare module 'framer/types/src/animation/Animators/LinearAnimator' {
    import { Animator } from "framer/types/src/animation/Animators/Animator";
    import { Interpolation, Interpolator } from "framer/types/src/interpolation/Interpolation";
    export const LinearDefaults: {
        duration: number;
    };
    export type Options = typeof LinearDefaults;
    export class LinearAnimator<Value> implements Animator<Value, Options> {
        current: Value;
        destination: Value;
        interpolator: Interpolator<Value>;
        progress: number;
        constructor(options?: Options, interpolation?: Interpolation<Value>);
        setFrom(value: Value): void;
...
declare module 'framer/types/src/animation/Animators/SpringAnimator' {
    ...
    export class SpringAnimator<Value> implements Animator<Value, Partial<TensionFrictionSpringOptions> | Partial<DampingDurationSpringOptions>> {
        constructor(options: Partial<TensionFrictionSpringOptions> | Partial<DampingDurationSpringOptions>, interpolation?: Interpolation<Value>);
        isReady(): boolean;
        next(delta: number): Value;
        isFinished(): boolean;
        setFrom(value: Value): void;
...
declare module 'framer/types/src/events/FramerEvent' {
    ...
    export class FramerEvent {
        ...
        readonly isLeftMouseClick: boolean;
    }
}
...
declare module 'framer/types/src/components/Scroll' {
    ...
    export type DraggableFrameProps = Partial<FrameProperties> & Partial<DraggableProps<typeof Frame>>;
...
declare module 'framer/types/src/components/Page' {
    import * as React from "react";
    import { AnimatableObject } from "framer/types/src/animation/Animatable";
    import { InertialScroll } from "framer/types/src/animation/Animators";
    ...
    export class Page extends React.Component<Props> {
        ...
        static supportsConstraints: boolean;
        pages: Rect[];
        animation: FramerAnimation | null;
...
declare module 'framer/types/src/components/Stack' {
    ...
    export class Stack extends Layer<StackProperties, StackState> {
        ...
        static updatedSize(props: Partial<StackProperties>, state: StackState): Size;
        ...
        static childLayoutRects(childSizes: Size[], size: Size, props: StackProperties): Rect[];
        static autoSize(minChildrenSizes: Size[], props: StackProperties): {
            width: number;
            height: number;
        };
...
declare module 'framer/types/src/components/devices/DeviceRenderer' {
    ...
    export class DeviceRenderer extends React.Component<DeviceRendererProperties> {
        ...
        getScreenStyle(screen: Size, device: Size, rotate: boolean, scale: number): React.CSSProperties;
        getMask(width: number, height: number, scale: number): JSX.Element | null;
...
declare module 'framer/types/src/render/utils/imageForFill' {
    ...
    export function imageForFill(image: BackgroundImage, quality: QualityOptions | null, imageBaseURL: string, style: React.CSSProperties): void;
    export function imageURL(imageName: string | null, intrinsicWidth: number | null, intrinsicHeight: number | null, quality: QualityOptions | null, imageBaseURL: string): string;
    export function imageScalingMethod(imageName: string | null, quality: QualityOptions | null, intrinsicWidth: number | null, intrinsicHeight: number | null, pixelWidth: number | null, pixelHeight: number | null, size?: ImageFit): "auto" | "pixelated";
}
...
declare module 'framer/types/src/render/utils/componentLoader' {
    ...
    import { FramerFunction } from "framer/types/src/data/WithFramerFunction";
    ...
    export type ComponentDefinition<P = any> = {
        ...
        type: ComponentType;
        external: boolean;
        class: React.ComponentType<P> | JSON | FramerFunction<any>;
    ...
    export function isReactDefinition<P = any>(d: ComponentDefinition): d is ReactComponentDefinition<P>;
    ...
    export type ComponentType = "component" | "device" | "deviceSkin" | "deviceHand" | "master" | "function";
...
declare module 'framer/types/src/render/types/PropertyControls' {
    ...
    export type ControlDescription<P = any> = BooleanControlDescription<P> | NumberControlDescription<P> | StringControlDescription<P> | FusedNumberControlDescription<P> | EnumControlDescription<P> | SegmentedEnumControlDescription<P> | ColorControlDescription<P> | ImageControlDescription<P> | ChildrenControlDescription<P>;
...
declare module 'framer/types/src/render/types/PathSegment' {
    ...
    export namespace PathSegment {
        ...
        const multiply: (point: PathSegment, value: number) => PathSegment;
        const assymetricPoint: (opposite: Point, size: Point) => Point;
        const reflectAlongLine: (point: PathSegment, lineStart: Point, lineEnd: Point) => PathSegment;
    }
}
...
declare module 'framer/types/src/render/style/shadow' {
    ...
    export function shadowForShape(boxShadows: BoxShadow[], rect: Rect, shapeId: string, shapeLink: string, fillAlpha: number, strokeAlpha: number, strokeWidth: number | undefined, strokeClipLink: string | undefined, svgStrokeAttributes: React.SVGAttributes<SVGElement>, canvasZoom: number, renderTarget: RenderTarget): {
...
declare module 'framer/types/src/render/presentation/PresentationTree' {
    ...
    export function convertPresentationTree<C, P extends LayerProps>(node: PresentationTree, converter: (node: PresentationTree, children: C[] | undefined) => C): C;
}
...
declare module 'framer/types/src/render/traits/ChildLayoutProvider' {
    ...
    export interface ChildLayoutProvider {
        childLayoutRects: (childSizes: Size[], size: Size, props: any) => Rect[];
    }
...
declare module 'framer/types/src/render/traits/AutoSize' {
    ...
    export interface AutoSize {
        autoSize(minChildrenSizes: Size[], props: any): Size;
    }
    export function hasAutoSize(node: any): node is AutoSize;
    export function toAutoSize(node: any, minChildrenSizes: Size[], props: any): Size | null;
}
...
declare module 'framer/types/src/render/config/fonts' {
    ...
    export const typefaces: OrderedMap<string, OrderedMap<string, {
        selector: string;
...
declare module 'framer/types/src/render/DesignComponentWrapper' {
    ...
    export function createDesignComponent<P>(canvas: CanvasStore, id: string, propertyControls: PropertyControls<P>, width?: number, height?: number): {
...
declare module 'framer/types/src/components/hoc/WithEvents' {
    ...
    export interface WithEventsProperties extends WithPanHandlers, WithTapHandlers, WithMouseWheelHandler {
...
declare module 'framer/types/src/render/types/Color/Color' {
    ...
    namespace Color {
        ...
        const interpolate: (colorA: Color, colorB: Color) => (progress: number) => Color;
        ...
        const span: (colorA: Color, colorB: Color) => number;
